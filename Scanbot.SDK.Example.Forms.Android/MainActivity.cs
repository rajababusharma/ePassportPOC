...
using ePassportPOC.Droid;

namespace Scanbot.SDK.Example.Forms.Droid
{
    [Activity(Label = "ePassportPOC", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
